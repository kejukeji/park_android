...
public class CopyOfMainActivity extends FragmentActivity {
		...
		etSearch.setOnKeyListener(new OnKeyListener() {
			...
			public boolean onKey(View v, int keyCode, KeyEvent event) {
				if(keyCode == KeyEvent.KEYCODE_ENTER){
					Intent intent = new Intent(CopyOfMainActivity.this, ShowRouteActivity.class);
		...
		mQueue.add(new JsonObjectRequest(Method.GET,
				...
				new Listener<JSONObject>() {
					...
					public void onResponse(JSONObject arg0) {
						Toast.makeText(CopyOfMainActivity.this, arg0.toString(), Toast.LENGTH_LONG).show();
	...
	private void initLocation() {
		if (!NetUtil.checkNet(this)) {
			Toast.makeText(CopyOfMainActivity.this, "没有网络", Toast.LENGTH_SHORT).show();
			finish();
			return;
		}
	...
	public class MySearchListener implements MKSearchListener {  
        ...
        public void onGetAddrResult(MKAddrInfo result, int iError) {  
        	...
        	city=kk.city;
        	Toast.makeText(CopyOfMainActivity.this, city, Toast.LENGTH_SHORT).show();
        }  
        @Override  
        ...
        public void onGetSuggestionResult(MKSuggestionResult result, int iError) {  
        	 ...
        	 if (iError!= 0 || result == null) {
                 Toast.makeText(CopyOfMainActivity.this, "抱歉，未找到结果", Toast.LENGTH_LONG).show(); 
                 return;
             }
             ...
             ArrayAdapter<String> suggestionString = new ArrayAdapter<String>(CopyOfMainActivity.this, android.R.layout.simple_list_item_1,mStrSuggestions);
	...
	public class MyLocationListenner implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			if (location == null) {
				Toast.makeText(CopyOfMainActivity.this, "定位失败", Toast.LENGTH_SHORT).show();
				return;
			}
			if (pd != null) {
				pd.dismiss();
